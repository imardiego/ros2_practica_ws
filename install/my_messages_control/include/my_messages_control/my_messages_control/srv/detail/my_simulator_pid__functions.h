...
#ifndef MY_MESSAGES_CONTROL__SRV__DETAIL__MY_SIMULATOR_PID__FUNCTIONS_H_
#define MY_MESSAGES_CONTROL__SRV__DETAIL__MY_SIMULATOR_PID__FUNCTIONS_H_
...
#include "my_messages_control/msg/rosidl_generator_c__visibility_control.h"

#include "my_messages_control/srv/detail/my_simulator_pid__struct.h"

/// Initialize srv/MySimulatorPID message.
/**
...
/// Create srv/MySimulatorPID message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_messages_control__srv__MySimulatorPID_Request__init().
...
/// Destroy srv/MySimulatorPID message.
/**
 * It calls
 * my_messages_control__srv__MySimulatorPID_Request__fini()
...
/// Check for srv/MySimulatorPID message equality.
/**
...
/// Copy a srv/MySimulatorPID message.
/**
...
/// Initialize array of srv/MySimulatorPID messages.
/**
...
/// Finalize array of srv/MySimulatorPID messages.
/**
 * It calls
 * my_messages_control__srv__MySimulatorPID_Request__fini()
...
/// Create array of srv/MySimulatorPID messages.
/**
 * It allocates the memory for the array and calls
 * my_messages_control__srv__MySimulatorPID_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MySimulatorPID messages.
/**
 * It calls
 * my_messages_control__srv__MySimulatorPID_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MySimulatorPID message array equality.
/**
...
/// Copy an array of srv/MySimulatorPID messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_messages_control__srv__MySimulatorPID_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_messages_control
...
/**
 * It calls
 * my_messages_control__srv__MySimulatorPID_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_messages_control
...
/**
 * It allocates the memory for the array and calls
 * my_messages_control__srv__MySimulatorPID_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_messages_control
...
/**
 * It calls
 * my_messages_control__srv__MySimulatorPID_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_MESSAGES_CONTROL__SRV__DETAIL__MY_SIMULATOR_PID__FUNCTIONS_H_
