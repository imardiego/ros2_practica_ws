...
bool my_messages_control__srv__my_simulator_pid__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_messages_control.srv._my_simulator_pid.MySimulatorPID_Request", full_classname_dest, 64) == 0);
  }
  my_messages_control__srv__MySimulatorPID_Request * ros_message = _ros_message;
  {  // kp
...
{
  /* NOTE(esteve): Call constructor of MySimulatorPID_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_messages_control.srv._my_simulator_pid");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MySimulatorPID_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool my_messages_control__srv__my_simulator_pid__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_messages_control.srv._my_simulator_pid.MySimulatorPID_Response", full_classname_dest, 65) == 0);
  }
  my_messages_control__srv__MySimulatorPID_Response * ros_message = _ros_message;
  {  // overshoot
...
{
  /* NOTE(esteve): Call constructor of MySimulatorPID_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_messages_control.srv._my_simulator_pid");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MySimulatorPID_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
