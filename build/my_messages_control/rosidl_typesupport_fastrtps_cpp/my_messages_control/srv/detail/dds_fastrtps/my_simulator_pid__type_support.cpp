...
#include "my_messages_control/srv/detail/my_simulator_pid__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_messages_control::srv::MySimulatorPID_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_messages_control::srv::MySimulatorPID_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_messages_control::srv::MySimulatorPID_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MySimulatorPID_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_messages_control::srv::MySimulatorPID_Request *>(
...
static size_t _MySimulatorPID_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MySimulatorPID_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MySimulatorPID_Request__callbacks = {
...
static rosidl_message_type_support_t _MySimulatorPID_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MySimulatorPID_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_my_messages_control
const rosidl_message_type_support_t *
get_message_type_support_handle<my_messages_control::srv::MySimulatorPID_Request>()
{
  return &my_messages_control::srv::typesupport_fastrtps_cpp::_MySimulatorPID_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_messages_control::srv::MySimulatorPID_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_messages_control::srv::MySimulatorPID_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_messages_control::srv::MySimulatorPID_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MySimulatorPID_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_messages_control::srv::MySimulatorPID_Response *>(
...
static size_t _MySimulatorPID_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MySimulatorPID_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MySimulatorPID_Response__callbacks = {
  "my_messages_control::srv",
...
static rosidl_message_type_support_t _MySimulatorPID_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MySimulatorPID_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &my_messages_control::srv::typesupport_fastrtps_cpp::_MySimulatorPID_Response__handle;
}
...
static service_type_support_callbacks_t _MySimulatorPID__callbacks = {
  "my_messages_control::srv",
  "MySimulatorPID",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_messages_control, srv, MySimulatorPID_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_messages_control, srv, MySimulatorPID_Response)(),
...
static rosidl_service_type_support_t _MySimulatorPID__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MySimulatorPID__callbacks,
...
{
  return &my_messages_control::srv::typesupport_fastrtps_cpp::_MySimulatorPID__handle;
}
