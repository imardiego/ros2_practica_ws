...
from std_msgs.msg import String  # importo este interfaz
...
class GeneticPerformanceClient(Node):
    ...
    # Cuando llega un valor por el topic lo utilizo para cambiar mi parámetro
    # el parámetro ha sido inicializado arriba con el valor "world"
...
def main():
    ...
    for generacion in range(generaciones):
        ...
        minimal_client.get_logger().info('Hello %s!' % minimal_client.my_param) # accedo a la variable
